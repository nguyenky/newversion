...
<body class="fix-header fix-sidebar">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="admin/images/users/5.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="admin/images/users/5.jpg" alt="user" class="profile-pic" /></a>
                                ...
                                <div class="testimonial-widget-one owl-carousel owl-theme">
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="admin/images/avatar/2.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="admin/images/avatar/3.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="admin/images/avatar/1.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="admin/images/avatar/4.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="admin/images/avatar/5.jpg" alt="" />
                                            <div class="testimonial-author">TYRION LANNISTER</div>
                                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="admin/images/avatar/6.jpg" alt="" />
                                            <div class="testimonial-author">TYRION LANNISTER</div>
                                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="admin/images/avatar/4.jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="admin/images/avatar/2.jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="admin/images/avatar/3.jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
								...
								<div class="recent-comment">
									<div class="media">
										<div class="media-left">
											<a href="#"><img alt="..." src="admin/images/avatar/1.jpg" class="media-object"></a>
										</div>
    ...
    <script src="admin/js/lib/bootstrap/admin/js/popper.min.js"></script>
    <script src="admin/js/lib/bootstrap/admin/js/bootstrap.min.js"></script>
